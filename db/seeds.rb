...
guest.profile_pic.attach(io: file1, filename: 'charles-deluvio-lJJlaUWYrPE-unsplash.jpg')
file2 = open('https://friendbook-seeds.s3.us-east-2.amazonaws.com/ignacio-correia-1_yycyoMT6g-unsplash.jpg')
guest.cover_photo.attach(io: file2, filename: 'ignacio-correia-1_yycyoMT6g-unsplash.jpg')
...
a1.profile_pic.attach(io: afile1, filename:'filip-havlik-N3GHOlnT_2c-unsplash.jpg')
a1.cover_photo.attach(io: afile2, filename: 'frank-mckenna-PdITidCbTM8-unsplash.jpg')
...
b1.profile_pic.attach(io: bfile1, filename:'david-straight-7QBElZQC-jE-unsplash.jpg')
b1.cover_photo.attach(io: bfile2, filename: 'garrett-sears-rXVFCA3fQ4I-unsplash.jpg')
...
c1.profile_pic.attach(io: cfile1, filename: 'liana-mikah-6KRmH6k3Rdk-unsplash.jpg')
c1.cover_photo.attach(io: cfile2, filename: 'liam-pozz-HZvGtncWvyQ-unsplash.jpg')
...
d1.profile_pic.attach(io: dfile1, filename: 'bruno-horwath-rSUeHOMrhZs-unsplash.jpg')
d1.cover_photo.attach(io: dfile2, filename: 'marlen-alimanov-kuwCCjTZEUk-unsplash.jpg')
...
g1.profile_pic.attach(io: gfile1, filename: 'jared-rice-NTyBbu66_SI-unsplash.jpg')
g1.cover_photo.attach(io: gfile2, filename: 'jo-arounding-c5SwN-KkE4g-unsplash.jpg')
...
e1.profile_pic.attach(io: efile1, filename: 'ricky-kharawala-adK3Vu70DEQ-unsplash.jpg' )
e1.cover_photo.attach(io: efile2, filename: 'chen-mizrach-jL6PTWI7h18-unsplash.jpg' )
